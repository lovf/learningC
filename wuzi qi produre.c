...
//			chessBoard[row][3], chessBoard[row][4]);
//
//	}
//	printf("+---+---+---+---+---+\n");
//}
...
//	//1.行对齐
//	for (int row = 0; row < Max_Row; row++){
//		if (chessBoard[row][0] != ' '&& chessBoard[row][0] == chessBoard[row][1] &&	chessBoard[row][0] == 
//			chessBoard[row][2] && chessBoard[row][0] == chessBoard[row][3]&&chessBoard[row][0] == 
//			chessBoard[row][4]){
//
...
//		if (chessBoard[0][col] != ' ' && chessBoard[0][col] == chessBoard[1][col] &&chessBoard[0][col] == 
//			chessBoard[2][col] && chessBoard[0][col] == chessBoard[3][col] && chessBoard[0][col] == 
//			chessBoard[4][col]){
//			return  chessBoard[0][col];
//		}
//	}
//	//3.对角线
//	if (chessBoard[0][0] != ' ' && chessBoard[0][0] == chessBoard[1][1] &&chessBoard[0][0] == 
//		chessBoard[2][2] && chessBoard[0][0] == chessBoard[3][3] && chessBoard[0][0] == chessBoard[4][4]){
//		return chessBoard[0][0];
//	}
//	if (chessBoard[0][4] != ' ' && chessBoard[0][4] == chessBoard[1][3] &&chessBoard[0][4] == 
//		chessBoard[2][2] && chessBoard[0][4] == chessBoard[3][1] && chessBoard[0][4] == 
//		chessBoard[4][0]){
